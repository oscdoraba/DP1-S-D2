...
<acme:form>
	...
	<acme:form-moment code="authenticated.inquiries.form.label.dateOfCreation" path="dateOfCreation"/>
	...
	<acme:form-textarea code="authenticated.inquiries.form.label.minMoney" path="minMoney" />
	<acme:form-textarea code="authenticated.inquiries.form.label.maxMoney" path="maxMoney" />
